...
#include <ACS712.h>               // RobTillaart/ACS712 0.3.5
...
ACS712 ACS(IOUT, 3.3, 4095, 58.67);
// using voltage divider R1 = 10k R2 = 20k
// voltage factor = 0.6667
// mVperAmp corrected = 100 * 0.6667 * 0.88 (12% loss from 5V source) = 58.67
